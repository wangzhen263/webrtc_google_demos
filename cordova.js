...
function iOSExec() {
    console.log('iOSExec begin! arguments[0]: ', arguments[0]);
    ...
    console.log('commandQueue: ', commandQueue.toString());
    if (bridgeMode === jsToNativeModes.WK_WEBVIEW_BINDING) {
        ...
        if (!isInContextOfEvalJs && commandQueue.length == 1) {
            console.log('commandQueue run pokeNative: ', commandQueue);
            pokeNative();
        } else {
            console.log('isInContextOfEvalJs: ', isInContextOfEvalJs);
            console.log('commandQueue.length: ', commandQueue.length);
        }
    }
    console.log('iOSExec begin!');
}
